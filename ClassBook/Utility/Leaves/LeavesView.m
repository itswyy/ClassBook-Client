...
- (void) willTurnToPageAtIndex:(NSUInteger)index {
	if ([_delegate respondsToSelector:@selector(leavesView:willTurnToPageAtIndex:)])
		[_delegate leavesView:self willTurnToPageAtIndex:index];
}

- (void) didTurnToPageAtIndex:(NSUInteger)index {
	if ([_delegate respondsToSelector:@selector(leavesView:didTurnToPageAtIndex:)])
		[_delegate leavesView:self didTurnToPageAtIndex:index];
}
